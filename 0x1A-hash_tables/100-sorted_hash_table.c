...
/**
 * sort_table - sorts hash table
 * @ht: hash table
 * @index: index of a new element
 *
 * Return: nothing
 */
 ...
 * @key: search key
 *
 * Return: value if the key exists and NULL if it doesn't exist
 */
...
/**
 * shash_table_print_rev - prints elements of a hash table in a reverse order
 * @ht: hash table
 *
 * Return: nothing
 */
